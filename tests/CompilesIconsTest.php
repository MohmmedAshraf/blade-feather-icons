...
use OutheBox\BladeFeatherIcons\BladeFeatherIconsServiceProvider;
...
class CompilesIconsTest extends TestCase
{
    ...
    {
        $result = svg('feather-wind')->toHtml();
    ...
    {
        $result = svg('feather-wind', 'w-6 h-6 text-gray-500')->toHtml();
    ...
    {
        $result = svg('feather-wind', ['style' => 'color: #555'])->toHtml();
